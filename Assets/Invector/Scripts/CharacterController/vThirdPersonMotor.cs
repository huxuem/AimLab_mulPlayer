...
namespace Invector.vCharacterController
{
    public class vThirdPersonMotor : MonoBehaviour
    {
        ...
        public virtual void MoveCharacter(Vector3 _direction)
        {
            ...
            /////////////////////////////
            Vector3 targetPosition = _rigidbody.position + _direction * (stopMove ? 0 : moveSpeed) * Time.fixedDeltaTime;

            if (transform.name == "Dwarf_remote")
            {
            ...
            // Debug.Log(transform.name + " " + _direction.magnitude);
